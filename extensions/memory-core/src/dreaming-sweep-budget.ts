...
export type DreamingWorkspaceBatchItem<T extends DreamingWorkspace = DreamingWorkspace> = T & {
  workspaceKey: string;
...
export function selectDreamingWorkspaceBatch<T extends DreamingWorkspace>(params: {
  workspaces: T[];
  nextWorkspaceKey?: string;
  limit?: number;
}): DreamingWorkspaceBatchItem<T>[] {
