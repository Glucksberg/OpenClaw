...
describe("parseModelCallbackData", () => {
  it("parses supported callback variants", () => {
    const cases = [
      ...
      ["mdl_back", { type: "back" }],
      ["mdl_panel_home", { type: "panel", action: "home" }],
      ["mdl_panel_details", { type: "panel", action: "details" }],
      ["mdl_panel_default", { type: "panel", action: "default" }],
      ["mdl_panel_providers", { type: "panel", action: "providers" }],
