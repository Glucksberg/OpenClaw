...
describe("normalizeBlueBubblesMessagingTarget", () => {
  ...
  it("preserves DM chat_guid format including service protocol (#26868)", () => {
    // DM format: service;-;handle — must retain chat_guid: prefix so the
    // service protocol (SMS vs iMessage) survives through outbound delivery.
